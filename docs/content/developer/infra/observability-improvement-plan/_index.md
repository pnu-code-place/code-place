...
14. Grafana의 `CodePlace AI Inference` dashboard에서 vLLM scrape, pod ready, waiting/running requests, KV cache, p95 latency, token throughput, HF cache PVC, GPU utilization/memory/temperature/XID panel이 비어 있지 않은지 확인합니다.
