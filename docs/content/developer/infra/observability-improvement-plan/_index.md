...
공개 사용자 경로는 Blackbox exporter 기반 synthetic probe로 별도 확인합니다. 이 probe는 frontend와 hub-auth 공개 URL을 30초 간격으로 호출해 DNS, Traefik TLS termination, frontend nginx, OAuth helper 기본 라우팅을 함께 검증합니다.
