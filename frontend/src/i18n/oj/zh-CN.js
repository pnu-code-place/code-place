export const m = {
  ...
  Where_is_the_input_and_the_output_answer_part_9:
    "写入 stdout。用户程序不允许读取或写入文件，否则您将收到",
  ...
  Underway_Contest: "进行中的比赛",
  Upcoming_Contest: "即将举办的比赛",
  Ongoing_And_Upcoming_Contests: "进行中及预定比赛",
