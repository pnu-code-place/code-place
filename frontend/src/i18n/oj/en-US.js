...
export const m = {
  ...
  Calendar_View: "달력",
  Calendar_Month_Title: "{year}년 {month}월",
  Calendar_Problem_Count: "총 {count}문제",
  Calendar_Month_Problem_Count: "이번 달 풀이 {count}개",
  Calendar_All_Problems: "월별 목록",
  Calendar_All_Problems_Empty: "표시할 문제가 없습니다.",
  Calendar_Weekday_Sun: "일",
  Calendar_Weekday_Mon: "월",
  Calendar_Weekday_Tue: "화",
  Calendar_Weekday_Wed: "수",
  Calendar_Weekday_Thu: "목",
  Calendar_Weekday_Fri: "금",
  Calendar_Weekday_Sat: "토",
  ...
  // PostDetail.vue
  Community_Question_Reopen: "질문 다시 열기",
  Community_Question_Close: "질문 닫기",
