...
export const m = {
  ...
  // ProfileSetting.vue
  Nickname : "닉네임",
  Nickname_Description: "다른 사람들에게 보여지며 마이페이지 주소로 사용됩니다.",
  ...
  Github_Description: "Github 아이디를 입력해주세요. 마이페이지에 링크와 함께 표시됩니다.",
  ...
  New_Password_Cannot_Be_The_Same_As_The_Current_Password: "새 비밀번호는 현재 비밀번호와 같을 수 없습니다.",
