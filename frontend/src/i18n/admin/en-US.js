export const m = {
  ...
  User_Table_Create_Time: "계정 생성일/마지막 로그인",
  User_Table_Last_Login: "마지막 로그인",
  User_Table_Real_Name: "실명",
  User_Table_Student_Id: "학번",
  User_Table_Email: "학교 이메일",
  User_Table_User_Type: "타입",
  User_Table_User_Avatar: "아바타",
  User_Table_User_College: "단과대학",
  User_Table_User_Department: "전공",
  ...
  Create_User_Table_Option_School: "학과정보 설정",
  Create_User_Table_Option_Account: "계정정보 설정",
  Create_User_Table_Prefix: "접두사",
  Create_User_Table_Number_Of_Mock: "생성인원 (명)",
  ...
  Create_User_Table_Notice:
    "※ {접두사}{1~생성인원+1}_{구분용 랜덤 문자열}@pusan.ac.kr 의 형태로 Mock 유저가 생성됩니다",
  ...
  User_Placeholder_College: "단과대학 선택",
  ...
  // AIHintStats
  AI_Hint_Start_Date: "시작일",
  AI_Hint_End_Date: "종료일",
  AI_Hint_Card_Turns: "총 사용 횟수",
  AI_Hint_Card_Sessions: "대화 수",
  AI_Hint_Card_Sessions_Note: "{minutes}분 간격으로 구분",
  AI_Hint_Card_Users: "사용 학생 수",
  AI_Hint_Card_Problems: "사용된 문제 수",
  AI_Hint_Card_Adoption: "채택률",
  AI_Hint_Card_Failure: "응답 실패율",

  AI_Hint_Usage_Trend: "사용 추이",
  AI_Hint_Monthly: "월별 사용량",
  AI_Hint_Hourly: "시간대별 사용량",
  AI_Hint_Turns: "사용 횟수",
  AI_Hint_Sessions: "대화 수",
  AI_Hint_Users: "학생 수",

  AI_Hint_Depth: "대화 깊이",
  AI_Hint_Turn_Distribution: "몇 번째 힌트까지 이어졌나",
  AI_Hint_Avg_Turns: "대화당 평균 횟수",
  AI_Hint_Single_Turn_Rate: "한 번에 끝난 비율",
  AI_Hint_Limit_Reached_Rate: "한도까지 사용한 비율",

  AI_Hint_Effect: "학습 효과",
  AI_Hint_Effect_Group: "구분",
  AI_Hint_Effect_With: "AI 조교 사용",
  AI_Hint_Effect_Without: "미사용",
  AI_Hint_Effect_Pairs: "대상 (학생·문제)",
  AI_Hint_Effect_Accepted: "정답 도달",
  AI_Hint_Effect_Rate: "정답 도달률",
  AI_Hint_Effect_Note:
    "무작위로 나뉜 집단이 아니므로 인과관계로 해석할 수 없습니다.",

  AI_Hint_Quality: "응답 품질",
  AI_Hint_Failure_Rate: "응답 실패율",
  AI_Hint_Label_Rate: "형식 준수율",
  AI_Hint_Label_Note: "응답이 [N단계] 머리말을 지킨 비율",
  AI_Hint_Length: "응답 길이 (글자)",
  AI_Hint_Nth_Turn: "{n}회째",
  AI_Hint_Length_Median: "중앙값",
  AI_Hint_Length_P90: "상위 10%",
  AI_Hint_Length_Max: "최대",

  AI_Hint_Top_Problems: "요청이 많은 문제",
  AI_Hint_Problem_ID: "문제 번호",
  AI_Hint_Problem_Title: "제목",
}
