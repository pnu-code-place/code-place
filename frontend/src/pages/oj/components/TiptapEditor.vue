<template>
  <div
    ...
    :class="{
      'is-focused': editor && editor.focused,
  ...
  >
    ...
    <div class="editor-menubar" v-if="editor && editable">
      ...
      <!-- H1 -->
      <div
        class="menubar__button btn-heading"
    ...
    <div
      ...
      :class="{ 'readonly-content': !editable }"
      :style="{ height: editable ? height : 'auto' }"
      @click="focusEditor"
    >
      ...
      Enter: (state, dispatch) => {
        ...
        if (match) {
          if (dispatch) {
            ...
            tr.setBlockType($from.start(), $from.start(), type, {
              language: match[1] || "python",
            })
            dispatch(tr)
          }
