...
<template>
  <div class="statistics">
    <div
      :class="`statistics-contents ${statExtendedClass(0)}`"
      @mouseenter="statSelect(0)"
    >
      ...
      <TotalProblems
        :extended="statExtended(0)"
        :total-problems="this.statistics.totalProblems"
      />
    </div>
    <hr />
    <div
      :class="`statistics-contents ${statExtendedClass(1)}`"
      @mouseenter="statSelect(1)"
    >
      <h3>
        {{ $t("m.NumberOfSolvedProblems") }}
      </h3>
      <SolvedProblems
        :extended="statExtended(1)"
        :solved-problems="this.statistics.solvedProblems"
      />
    </div>
    <hr />
    <div
      :class="`statistics-contents ${statExtendedClass(2)}`"
      @mouseenter="statSelect(2)"
    >
      ...
      <HeldContests
        :extended="statExtended(2)"
        :held-contests="this.statistics.heldContests"
      />
    </div>
  </div>
</template>
