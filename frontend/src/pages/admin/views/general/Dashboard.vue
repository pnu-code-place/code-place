    ...
    <el-col :md="14" :lg="16" v-if="isSuperAdmin">
      ...
      <panel style="margin-top: 5px">
        ...
        <el-popover placement="right" trigger="hover">
          ...
          <p>{{$t('m.Release_Tooltip_Content')}}</p>
          <p>{{$t('m.Release_Tooltip_Reference')}}: <a href="http://docs.onlinejudge.me/#/onlinejudge/guide/upgrade" target="_blank">
